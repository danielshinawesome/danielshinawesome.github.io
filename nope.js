...
if((q1 == "potstickers" || q1 == "Potstickers") || (q1 == "potsticker" || q1 == "Potsticker")) {
  ...
  alert = alert("Did you mean to type in 'Potstickers'? Geez, get better at your typing skills.");
}
var q2 = prompt("What is your favorite color?");
if(q1 == "yellow" || q1 == "Yellow") {
  alert = alert("Great!");
} else {
  alert = alert("Did you mean to type in 'Yellow'? You need to upgrade your typing skills.");
}
var q3 = prompt("What is your favorite number?")
if(q1 == "42") {
  alert = alert("Great!");
} else {
  alert = alert("Did you mean to type in '42'? I seriously recommend nitrotype.com to help your terrible type skills.");
}
var q4 = prompt("what level is your typing skills?")
if(q4 == "OVER 9,000!!!!!") {
  alert = alert("you actually did something!");
} else {
